...
async def main():
    ...
    await bot.connect(server, main_channel)
    ...
    while True:
        ...
        if (msg.msg_type == "PRIVMSG" and msg.channel == nickname):
            ...
            # private message.
            await bot.privmsg(msg.sender, "Hello, I'm a bot skeleton. I can't really "
        ...
        if (msg.msg_type == "JOIN" and msg.channel == main_channel and
                msg.sender != nickname):
            await bot.privmsg(msg.channel, "Hello %s, welcome to %s!" %
            ...
            if (msg.sender.lower() == "enfors"):
                await bot.make_operator(msg.channel, msg.sender)
        ...
        if (msg.msg_type == "PART" and msg.channel == main_channel and
                msg.sender != nickname):
            await bot.privmsg(msg.sender, "Please come back to %s soon!" %
                              msg.channel)
